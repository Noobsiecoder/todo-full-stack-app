...
// Custom module
const { DB_DETAILS } = require("./app/config/config"),
...
// MongoDB URI
const mongoDbUri = `mongodb+srv://${dbUserName}:${dbPassword}@todoapp.b50kz.mongodb.net/${dbName}?retryWrites=true&w=majority`;
